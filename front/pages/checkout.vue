                ...
                <v-row>
                  ...
                  <v-col class="center" cols="12" sm="12" md="12">
                    <div class="">
                      ...
                      <NuxtLink class="btn change-color btn-borde" :to="{ path: '/' }"
                ...
                <v-col class="center" cols="12" sm="12" md="12">
                  ...
                  <no-ssr>
                    <paypal-checkout
                      ...
                      currency="CAD"
                      :locale="
                        $i18n.locale.toString() == 'en'
                          ? $i18n.locale.toString() + '_US'
                          : $i18n.locale.toString() +
                            '_' +
                            $i18n.locale.toString().toUpperCase()
                      "
                      :client="
                        selectedPaymentProvider.data
                          ? {
                              [paypalEnv]:
                                selectedPaymentProvider.data.client_id
                            }
                          : ''
                      "
