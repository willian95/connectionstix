    ...
    <div id="open-modal" :class="'modal-window open-modal ' + modalClass">
      <div class="modal-table">
        ...
        <button
          title="Close"
          class="modal-close"
          @click="closeCancellationPolicyModal()"
        >
          x
        </button>
      </div>
      ...
      <v-col cols="12" sm="3" md="3">
        <v-card class="pa-2" outlined tile>
          <div class="main-min" v-if="cancellationPolicy">
            <button
              class="flex"
              @click="showCancellationPolicyModal(cancellationPolicy)"
            >
      ...
      <div class="items itemend">
        <div class="end">
          <button
            ...
            :disabled="isDisabled && discountCode == discountCodeProp"
            @click="update()"
            v-show="!onLoadingUpdate"
          >
            {{ $t("update") }}
          </button>
          <center>
